...
public class ItemUpdatesController extends Controller {
        ...
        if (isGet()) {
            ...
            for (int i = 0; i < arr.length(); i++) {
                ...
                // any new stuffs update ===================================
                    ...
                    item.setSyncDirty(true);
                    Datastore.put(item);
                    item.setSyncDirty(false);
                }
